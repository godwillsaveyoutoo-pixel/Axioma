...
const GAMES=[
  ...
  {id:'getallenfrontier',title:'Getallenfrontier',domain:'getallen',domains:['getallen','games'],math:'Reële getallen, wortels & intervallen',desc:'Verken de reële getallijn via schrijfwijzen, decimalen, wortels, intervallen, schatten en getallenverzamelingen.',file:'games/getallenfrontier.html',accent:'#0a84ff',total:28,featured:false,orientation:'any',
    progress(){const v=readJSON('gf_done',[]);return Array.isArray(v)?new Set(v).size:0}},
  {id:'koersveld',title:'Koersveld',domain:'meetkunde',domains:['meetkunde','games'],math:'Vectoren in het vlak',desc:'Teken, verplaats, combineer en ontbind vectoren in tien leerreeksen met korte bonusspellen.',file:'games/koersveld.html',accent:'#72e3e9',total:42,featured:false,orientation:'landscape',
    progress(){const v=readJSON('koersveld-v07',{});return v?.done&&typeof v.done==='object'?Object.keys(v.done).length:0}},
